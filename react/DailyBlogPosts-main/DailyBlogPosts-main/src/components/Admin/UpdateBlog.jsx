...
const UpdateBlog = () => {
  ...
  const UpdateBlog = () => {
    ...
    axios.put(`http://localhost:8001/blogs/${id}`, formData).then((response) => {
      SetMessage(true);
      setTimeout(() => {
        SetMessage(false);
      }, 2000);
  ...
  return (
    <>
      <div
        className={`bg-green-100 border-[1px] border-green-600 p-2 px-10 absolute rounded-lg shadow-lg top-0 left-[50%] transition-all ease-in-out duration-700 z-[-20] ${
